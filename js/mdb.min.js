...
jQuery.easing.jswing = jQuery.easing.swing, jQuery.extend(jQuery.easing, {
  def: "easeOutQuad",
  swing: function swing(e, t, i, n, o) {
    return jQuery.easing[jQuery.easing.def](e, t, i, n, o);
  },
  easeInQuad: function easeInQuad(e, t, i, n, o) {
    return n * (t /= o) * t + i;
  },
  easeOutQuad: function easeOutQuad(e, t, i, n, o) {
    return -n * (t /= o) * (t - 2) + i;
  },
  easeInOutQuad: function easeInOutQuad(e, t, i, n, o) {
    return (t /= o / 2) < 1 ? n / 2 * t * t + i : -n / 2 * (--t * (t - 2) - 1) + i;
  },
  easeInCubic: function easeInCubic(e, t, i, n, o) {
    return n * (t /= o) * t * t + i;
  },
  easeOutCubic: function easeOutCubic(e, t, i, n, o) {
    return n * ((t = t / o - 1) * t * t + 1) + i;
  },
  easeInOutCubic: function easeInOutCubic(e, t, i, n, o) {
    return (t /= o / 2) < 1 ? n / 2 * t * t * t + i : n / 2 * ((t -= 2) * t * t + 2) + i;
  },
  easeInQuart: function easeInQuart(e, t, i, n, o) {
    return n * (t /= o) * t * t * t + i;
  },
  easeOutQuart: function easeOutQuart(e, t, i, n, o) {
    return -n * ((t = t / o - 1) * t * t * t - 1) + i;
  },
  easeInOutQuart: function easeInOutQuart(e, t, i, n, o) {
    return (t /= o / 2) < 1 ? n / 2 * t * t * t * t + i : -n / 2 * ((t -= 2) * t * t * t - 2) + i;
  },
  easeInQuint: function easeInQuint(e, t, i, n, o) {
    return n * (t /= o) * t * t * t * t + i;
  },
  easeOutQuint: function easeOutQuint(e, t, i, n, o) {
    return n * ((t = t / o - 1) * t * t * t * t + 1) + i;
  },
  easeInOutQuint: function easeInOutQuint(e, t, i, n, o) {
    return (t /= o / 2) < 1 ? n / 2 * t * t * t * t * t + i : n / 2 * ((t -= 2) * t * t * t * t + 2) + i;
  },
  easeInSine: function easeInSine(e, t, i, n, o) {
    return -n * Math.cos(t / o * (Math.PI / 2)) + n + i;
  },
  easeOutSine: function easeOutSine(e, t, i, n, o) {
    return n * Math.sin(t / o * (Math.PI / 2)) + i;
  },
  easeInOutSine: function easeInOutSine(e, t, i, n, o) {
    return -n / 2 * (Math.cos(Math.PI * t / o) - 1) + i;
  },
  easeInExpo: function easeInExpo(e, t, i, n, o) {
    return 0 == t ? i : n * Math.pow(2, 10 * (t / o - 1)) + i;
  },
  easeOutExpo: function easeOutExpo(e, t, i, n, o) {
    return t == o ? i + n : n * (1 - Math.pow(2, -10 * t / o)) + i;
  },
  easeInOutExpo: function easeInOutExpo(e, t, i, n, o) {
    return 0 == t ? i : t == o ? i + n : (t /= o / 2) < 1 ? n / 2 * Math.pow(2, 10 * (t - 1)) + i : n / 2 * (2 - Math.pow(2, -10 * --t)) + i;
  },
  easeInCirc: function easeInCirc(e, t, i, n, o) {
    return -n * (Math.sqrt(1 - (t /= o) * t) - 1) + i;
  },
  easeOutCirc: function easeOutCirc(e, t, i, n, o) {
    return n * Math.sqrt(1 - (t = t / o - 1) * t) + i;
  },
  easeInOutCirc: function easeInOutCirc(e, t, i, n, o) {
    return (t /= o / 2) < 1 ? -n / 2 * (Math.sqrt(1 - t * t) - 1) + i : n / 2 * (Math.sqrt(1 - (t -= 2) * t) + 1) + i;
  },
  easeInElastic: function easeInElastic(e, t, i, n, o) {
    var a = 1.70158,
        r = 0,
        s = n;
    if (0 == t) return i;
  ...
  easeOutElastic: function easeOutElastic(e, t, i, n, o) {
    var a = 1.70158,
        r = 0,
        s = n;
    if (0 == t) return i;
  ...
  easeInOutElastic: function easeInOutElastic(e, t, i, n, o) {
    var a = 1.70158,
        r = 0,
        s = n;
    if (0 == t) return i;
  ...
  easeInOutBounce: function easeInOutBounce(e, t, i, n, o) {
  ...
  if (!e.jQuery) {
    ...
    i.isWindow = function (e) {
      ...
      return null == e ? e + "" : "object" == _typeof2(e) || "function" == typeof e ? o[r.call(e)] || "object" : _typeof2(e);
      ...
      for ("boolean" == typeof s && (c = s, s = arguments[l] || {}, l++), "object" != _typeof2(s) && "function" !== i.type(s) && (s = {}), l === u && (s = this, l--); u > l; l++) {
        if (null != (a = arguments[l])) for (o in a) {
          e = s[o], s !== (n = a[o]) && (c && n && (i.isPlainObject(n) || (t = i.isArray(n))) ? (t ? (t = !1, r = e && i.isArray(e) ? e : []) : r = e && i.isPlainObject(e) ? e : {}, s[o] = i.extend(c, r, n)) : void 0 !== n && (s[o] = n));
        }
      }
  ...
  "object" == (typeof module === "undefined" ? "undefined" : _typeof2(module)) && "object" == _typeof2(module.exports) ? module.exports = e() : "function" == typeof define && define.amd ? define(e) : e();
}(function () {
  return function (e, t, i, n) {
    ...
    function r(e, i, n, o) {
      ...
      var x = b ? new Float32Array(g) : new Array(g),
          T = !1,
          C = function C(t) {
        return T || p(), e === i && n === o ? t : 0 === t ? 0 : 1 === t ? 1 : l(function (t) {
          for (var i = 0, o = 1, a = g - 1; o != a && x[o] <= t; ++o) {
            i += y;
          }

          var r = i + (t - x[--o]) / (x[o + 1] - x[o]) * y,
              s = u(r, e, n);
          return s >= h ? c(t, r) : 0 == s ? r : d(t, i, i + y);
        }(t), i, o);
      };
    ...
    function s(e, t) {
      var i = e;
      return f.isString(e) ? g.Easings[e] || (i = !1) : i = f.isArray(e) && 1 === e.length ? function (e) {
        return function (t) {
          return Math.round(t * e) * (1 / e);
        };
      }.apply(null, e) : f.isArray(e) && 2 === e.length ? y.apply(null, e.concat([t])) : !(!f.isArray(e) || 4 !== e.length) && r.apply(null, e), !1 === i && (i = g.Easings[g.defaults.easing] ? g.defaults.easing : v), i;
    }
          ...
          if (g.State.calls[o]) {
            ...
            for (var v = Math.min((t - p) / d.duration, 1), y = 0, w = s.length; w > y; y++) {
              ...
              if (a(C)) {
                ...
                for (var E in d.visibility !== n && "hidden" !== d.visibility && b.setPropertyValue(C, "visibility", d.visibility), T) {
                  if ("element" !== E) {
                    var I,
                        A = T[E],
                        P = f.isString(A.easing) ? g.Easings[A.easing] : A.easing;
                    if (1 === v) I = A.endValue;else {
                      var k = A.endValue - A.startValue;
                      if (I = A.startValue + k * P(v, d, k), !h && I === A.currentValue) continue;
                    }
                    if (A.currentValue = I, "tween" === E) m = I;else {
                      if (b.Hooks.registered[E]) {
                        var O = b.Hooks.getRoot(E),
                            D = a(C).rootPropertyValueCache[O];
                        D && (A.rootPropertyValue = D);
                      }

                      var M = b.setPropertyValue(C, E, A.currentValue + (0 === parseFloat(I) ? "" : A.unitType), A.rootPropertyValue, A.scrollData);
                      b.Hooks.registered[E] && (a(C).rootPropertyValueCache[O] = b.Normalizations.registered[O] ? b.Normalizations.registered[O]("extract", null, M[1]) : M[1]), "transform" === M[0] && (S = !0);
                    }
                  }
                }
            ...
            d.display !== n && "none" !== d.display && (g.State.calls[o][2].display = !1), d.visibility !== n && "hidden" !== d.visibility && (g.State.calls[o][2].visibility = !1), d.progress && d.progress.call(r[1], r[1], v, Math.max(0, p + d.duration - t), p, m), 1 === v && u(o);
          }
        }
      }
    ...
    function u(e, t) {
      ...
      for (var i = g.State.calls[e][0], o = g.State.calls[e][1], r = g.State.calls[e][2], s = g.State.calls[e][4], l = !1, u = 0, d = i.length; d > u; u++) {
        var p = i[u].element;

        if (t || r.loop || ("none" === r.display && b.setPropertyValue(p, "display", r.display), "hidden" === r.visibility && b.setPropertyValue(p, "visibility", r.visibility)), !0 !== r.loop && (c.queue(p)[1] === n || !/\.velocityQueueEntryFlag/i.test(c.queue(p)[1])) && a(p)) {
          a(p).isAnimating = !1, a(p).rootPropertyValueCache = {};
          var f = !1;
          c.each(b.Lists.transforms3D, function (e, t) {
            var i = /^scale/.test(t) ? 1 : 0,
                o = a(p).transformCache[t];
            a(p).transformCache[t] !== n && new RegExp("^\\(" + i + "[^.]").test(o) && (f = !0, delete a(p).transformCache[t]);
          }), r.mobileHA && (f = !0, delete a(p).transformCache.translate3d), f && b.flushTransformCache(p), b.Values.removeClass(p, "velocity-animating");
        }

        if (!t && r.complete && !r.loop && u === d - 1) try {
          r.complete.call(o, o);
        } catch (e) {
          setTimeout(function () {
            throw e;
        ...
        s && !0 !== r.loop && s(o), a(p) && !0 === r.loop && !t && (c.each(a(p).tweensContainer, function (e, t) {
          /^rotate/.test(e) && 360 === parseFloat(t.endValue) && (t.endValue = 0, t.startValue = 360), /^backgroundPosition/.test(e) && 100 === parseFloat(t.endValue) && "%" === t.unitType && (t.endValue = 0, t.startValue = 100);
        }), g(p, "reverse", {
          loop: !0,
          delay: r.delay
        })), !1 !== r.queue && c.dequeue(p, r.queue);
      }
    ...
    var c,
      ...
      isNodeList: function isNodeList(e) {
        return "object" == _typeof2(e) && /^\[object (HTMLCollection|NodeList|Object)\]$/.test(Object.prototype.toString.call(e)) && e.length !== n && (0 === e.length || "object" == _typeof2(e[0]) && e[0].nodeType > 0);
      },
    ...
    if (e.fn && e.fn.jquery ? (c = e, h = !0) : c = t.Velocity.Utilities, 8 >= d && !h) throw new Error("Velocity: IE8 and below require jQuery to be loaded before Velocity.");
    ...
    if (!(7 >= d)) {
      ...
      var y = function () {
        ...
        return function e(t, n, o) {
          ...
          for (t = parseFloat(t) || 500, n = parseFloat(n) || 20, o = o || null, l.tension = t, l.friction = n, (a = null !== o) ? r = (c = e(t, n)) / o * .016 : r = .016; s = i(s || l, r), u.push(1 + s.x), c += 16, Math.abs(s.x) > 1e-4 && Math.abs(s.v) > 1e-4;) {
            ;
          }
      ...
      var b = g.CSS = {
        ...
        Hooks: {
          ...
          injectValue: function injectValue(e, t, i) {
        ...
        Normalizations: {
          registered: {
            ...
            opacity: function opacity(e, t, i) {
              if (8 >= d) switch (e) {
                case "name":
                  return "filter";
        ...
        Names: {
          ...
          prefixCheck: function prefixCheck(e) {
            ...
            for (var t = ["", "Webkit", "Moz", "ms", "O"], i = 0, n = t.length; n > i; i++) {
              ...
              }), f.isString(g.State.prefixElement.style[o])) return g.State.prefixMatches[e] = o, [o, !0];
            }
        ...
        getPropertyValue: function getPropertyValue(e, i, o, r) {
          function s(e, i) {
            function o() {
            ...
            if (8 >= d) l = c.css(e, i);else {
              ...
              u = a(e) === n ? t.getComputedStyle(e, null) : a(e).computedStyle ? a(e).computedStyle : a(e).computedStyle = t.getComputedStyle(e, null), "borderColor" === i && (i = "borderTopColor"), ("" === (l = 9 === d && "filter" === i ? u.getPropertyValue(i) : u[i]) || null === l) && (l = e.style[i]), o();
            }
          ...
          if (b.Hooks.registered[i]) {
            var u = i,
                p = b.Hooks.getRoot(u);
            o === n && (o = b.getPropertyValue(e, b.Names.prefixCheck(p)[0])), b.Normalizations.registered[p] && (o = b.Normalizations.registered[p]("extract", e, o)), l = b.Hooks.extractValue(u, o);
          } else if (b.Normalizations.registered[i]) {
            var f, h;
            "transform" !== (f = b.Normalizations.registered[i]("name", e)) && (h = s(e, b.Names.prefixCheck(f)[0]), b.Values.isCSSNullValue(h) && b.Hooks.templates[i] && (h = b.Hooks.templates[i][1])), l = b.Normalizations.registered[i]("extract", e, h);
          }

          if (!/^[\d-]/.test(l)) if (a(e) && a(e).isSVG && b.Names.SVGAttribute(i)) {
        ...
        setPropertyValue: function setPropertyValue(e, i, n, o, r) {
          var s = i;
          if ("scroll" === i) r.container ? r.container["scroll" + r.direction] = n : "Left" === r.direction ? t.scrollTo(n, r.alternateValue) : t.scrollTo(r.alternateValue, n);else if (b.Normalizations.registered[i] && "transform" === b.Normalizations.registered[i]("name", e)) b.Normalizations.registered[i]("inject", e, n), s = "transform", n = a(e).transformCache[i];else {
            if (b.Hooks.registered[i]) {
              var l = i,
                  u = b.Hooks.getRoot(i);
              o = o || b.getPropertyValue(e, u), n = b.Hooks.injectValue(l, n, o), i = u;
            }
      ...
      b.Hooks.register(), b.Normalizations.register(), g.hook = function (e, t, i) {
        ...
        return e = o(e), c.each(e, function (e, o) {
          if (a(o) === n && g.init(o), i === n) r === n && (r = g.CSS.getPropertyValue(o, t));else {
      ...
      var w = function w() {
        ...
        function r() {
          function e(e) {
            function p(e, t) {
              var i = n,
                  o = n,
                  a = n;
              return f.isArray(e) ? (i = e[0], !f.isArray(e[1]) && /^[\d-]/.test(e[1]) || f.isFunction(e[1]) || b.RegEx.isHex.test(e[1]) ? a = e[1] : (f.isString(e[1]) && !b.RegEx.isHex.test(e[1]) || f.isArray(e[1])) && (o = t ? e[1] : s(e[1], u.duration), e[2] !== n && (a = e[2]))) : i = e, t || (o = o || u.easing), f.isFunction(i) && (i = i.call(r, S, C)), f.isFunction(a) && (a = a.call(r, S, C)), [i || 0, o, a];
            }
            ...
            function m() {
              var e = {
                ...
                fontSize: b.getPropertyValue(r, "fontSize")
                  ...
                  o = e.fontSize === F.lastFontSize;
              F.lastParent = e.myParent, F.lastPosition = e.position, F.lastFontSize = e.fontSize;
              var s = 100,
                  l = {};
              if (o && n) l.emToPx = F.lastEmToPx, l.percentToPxWidth = F.lastPercentToPxWidth, l.percentToPxHeight = F.lastPercentToPxHeight;else {
                var u = a(r).isSVG ? i.createElementNS("http://www.w3.org/2000/svg", "rect") : i.createElement("div");
                g.init(u), e.myParent.appendChild(u), c.each(["overflow", "overflowX", "overflowY"], function (e, t) {
                  g.CSS.setPropertyValue(u, t, "hidden");
                }), g.CSS.setPropertyValue(u, "position", e.position), g.CSS.setPropertyValue(u, "fontSize", e.fontSize), g.CSS.setPropertyValue(u, "boxSizing", "content-box"), c.each(["minWidth", "maxWidth", "width", "minHeight", "maxHeight", "height"], function (e, t) {
                  g.CSS.setPropertyValue(u, t, s + "%");
                }), g.CSS.setPropertyValue(u, "paddingLeft", s + "em"), l.percentToPxWidth = F.lastPercentToPxWidth = (parseFloat(b.getPropertyValue(u, "width", null, !0)) || 1) / s, l.percentToPxHeight = F.lastPercentToPxHeight = (parseFloat(b.getPropertyValue(u, "height", null, !0)) || 1) / s, l.emToPx = F.lastEmToPx = (parseFloat(b.getPropertyValue(u, "paddingLeft")) || 1) / s, e.myParent.removeChild(u);
              }
              return null === F.remToPx && (F.remToPx = parseFloat(b.getPropertyValue(i.body, "fontSize")) || 16), null === F.vwToPx && (F.vwToPx = parseFloat(t.innerWidth) / 100, F.vhToPx = parseFloat(t.innerHeight) / 100), l.remToPx = F.remToPx, l.vwToPx = F.vwToPx, l.vhToPx = F.vhToPx, g.debug >= 1 && console.log("Unit ratios: " + JSON.stringify(l), r), l;
            }
            ...
            if ("scroll" === I) {
              var w,
                  T,
                  E,
                  P = /^x$/i.test(u.axis) ? "Left" : "Top",
                  k = parseFloat(u.offset) || 0;
              u.container ? f.isWrapped(u.container) || f.isNode(u.container) ? (u.container = u.container[0] || u.container, E = (w = u.container["scroll" + P]) + c(r).position()[P.toLowerCase()] + k) : u.container = null : (w = g.State.scrollAnchor[g.State["scrollProperty" + P]], T = g.State.scrollAnchor[g.State["scrollProperty" + ("Left" === P ? "Top" : "Left")]], E = c(r).offset()[P.toLowerCase()] + k), d = {
                scroll: {
                  rootPropertyValue: !1,
                  startValue: w,
                  currentValue: w,
              ...
              if (!a(r).tweensContainer) return void c.dequeue(r, u.queue);
              "none" === a(r).opts.display && (a(r).opts.display = "auto"), "hidden" === a(r).opts.visibility && (a(r).opts.visibility = "visible"), a(r).opts.loop = !1, a(r).opts.begin = null, a(r).opts.complete = null, x.easing || delete u.easing, x.duration || delete u.duration, u = c.extend({}, a(r).opts, u);
              var O = c.extend(!0, {}, a(r).tweensContainer);

              for (var D in O) {
                if ("element" !== D) {
                  var M = O[D].startValue;
                  O[D].startValue = O[D].currentValue = O[D].endValue, O[D].endValue = M, f.isEmptyObject(x) || (O[D].easing = u.easing), g.debug && console.log("reverse tweensContainer (" + D + "): " + JSON.stringify(O[D]), r);
                }
              }

              d = O;
            } else if ("start" === I) {
              for (var L in a(r).tweensContainer && !0 === a(r).isAnimating && (O = a(r).tweensContainer), c.each(y, function (e, t) {
                if (RegExp("^" + b.Lists.colors.join("$|^") + "$").test(e)) {
                  ...
                  if (b.RegEx.isHex.test(o)) {
                    for (var s = ["Red", "Green", "Blue"], l = b.Values.hexToRgb(o), u = r ? b.Values.hexToRgb(r) : n, c = 0; c < s.length; c++) {
                      var d = [l[c]];
                ...
                var N = b.Hooks.getRoot(L),
                    j = !1;

                if (a(r).isSVG || "tween" === N || !1 !== b.Names.prefixCheck(N)[1] || b.Normalizations.registered[N] !== n) {
                  (u.display !== n && null !== u.display && "none" !== u.display || u.visibility !== n && "hidden" !== u.visibility) && /opacity|filter/.test(L) && !z && 0 !== R && (z = 0), u._cacheValues && O && O[L] ? (z === n && (z = O[L].endValue + O[L].unitType), j = a(r).rootPropertyValueCache[N]) : b.Hooks.registered[L] ? z === n ? (j = b.getPropertyValue(r, N), z = b.getPropertyValue(r, L, j)) : j = b.Hooks.templates[N][1] : z === n && (z = b.getPropertyValue(r, L));
                  var H,
                      W,
                      Y,
                      q = !1;
                  if (z = (H = h(L, z))[0], Y = H[1], R = (H = h(L, R))[0].replace(/^([+-\/*])=/, function (e, t) {
                    return q = t, "";
                  }), W = H[1], z = parseFloat(z) || 0, R = parseFloat(R) || 0, "%" === W && (/^(fontSize|lineHeight)$/.test(L) ? (R /= 100, W = "em") : /^scale/.test(L) ? (R /= 100, W = "") : /(Red|Green|Blue)$/i.test(L) && (R = R / 100 * 255, W = "")), /[\/*]/.test(q)) W = Y;else if (Y !== W && 0 !== z) if (0 === R) W = Y;else {
                    o = o || m();
            ...
            d.element && (b.Values.addClass(r, "velocity-animating"), V.push(d), "" === u.queue && (a(r).tweensContainer = d, a(r).opts = u), a(r).isAnimating = !0, S === C - 1 ? (g.State.calls.push([V, v, u, null, A.resolver]), !1 === g.State.isTicking && (g.State.isTicking = !0, l())) : S++);
          }

          var o,
              r = this,
              u = c.extend({}, g.defaults, x),
              d = {};

          switch (a(r) === n && g.init(r), parseFloat(u.delay) && !1 !== u.queue && c.queue(r, u.queue, function (e) {
          ...
          !1 !== g.mock && (!0 === g.mock ? u.duration = u.delay = 1 : (u.duration *= parseFloat(g.mock) || 1, u.delay *= parseFloat(g.mock) || 1)), u.easing = s(u.easing, u.duration), u.begin && !f.isFunction(u.begin) && (u.begin = null), u.progress && !f.isFunction(u.progress) && (u.progress = null), u.complete && !f.isFunction(u.complete) && (u.complete = null), u.display !== n && null !== u.display && (u.display = u.display.toString().toLowerCase(), "auto" === u.display && (u.display = g.CSS.Values.getDisplayType(r))), u.visibility !== n && null !== u.visibility && (u.visibility = u.visibility.toString().toLowerCase()), u.mobileHA = u.mobileHA && g.State.isMobile && !g.State.isGingerbread, !1 === u.queue ? u.delay ? setTimeout(e, u.delay) : e() : c.queue(r, u.queue, function (t, i) {
            return !0 === i ? (A.promise && A.resolver(v), !0) : (g.velocityQueueEntryFlag = !0, void e());
          }), "" !== u.queue && "fx" !== u.queue || "inprogress" === c.queue(r)[0] || c.dequeue(r);
        }
        ...
        var d,
            ...
            y,
            x,
            T = arguments[0] && (arguments[0].p || c.isPlainObject(arguments[0].properties) && !arguments[0].properties.names || f.isString(arguments[0].properties));

        if (f.isWrapped(this) ? (d = !1, h = 0, v = this, p = this) : (d = !0, h = 1, v = T ? arguments[0].elements || arguments[0].e : arguments[0]), v = o(v)) {
          T ? (y = arguments[0].properties || arguments[0].p, x = arguments[0].options || arguments[0].o) : (y = arguments[h], x = arguments[h + 1]);
          var C = v.length,
              S = 0;

          if (!/^(stop|finish)$/i.test(y) && !c.isPlainObject(x)) {
            x = {};

            for (var E = h + 1; E < arguments.length; E++) {
              f.isArray(arguments[E]) || !/^(fast|normal|slow)$/i.test(arguments[E]) && !/^\d/.test(arguments[E]) ? f.isString(arguments[E]) || f.isArray(arguments[E]) ? x.easing = arguments[E] : f.isFunction(arguments[E]) && (x.complete = arguments[E]) : x.duration = arguments[E];
            }
          }
          ...
          switch (d && g.Promise && (A.promise = new g.Promise(function (e, t) {
            ...
            case "stop":
              ...
              var P = [];
              return c.each(g.State.calls, function (e, t) {
                t && c.each(t[1], function (i, o) {
                  var r = x === n ? "" : x;
                  return !0 !== r && t[2].queue !== r && (x !== n || !1 !== t[2].queue) || void c.each(v, function (i, n) {
                    n === o && ((!0 === x || f.isString(x)) && (c.each(c.queue(n, f.isString(x) ? x : ""), function (e, t) {
                      f.isFunction(t) && t(null, !0);
                    }), c.queue(n, f.isString(x) ? x : "", [])), "stop" === y ? (a(n) && a(n).tweensContainer && !1 !== r && c.each(a(n).tweensContainer, function (e, t) {
                      t.endValue = t.currentValue;
                    }), P.push(e)) : "finish" === y && (t[2].duration = 1));
                  });
                });
              }), "stop" === y && (c.each(P, function (e, t) {
                u(t, !0);
              }), A.promise && A.resolver(v)), e();

            default:
              if (!c.isPlainObject(y) || f.isEmptyObject(y)) {
                if (f.isString(y) && g.Redirects[y]) {
                  var k = (L = c.extend({}, x)).duration,
                      O = L.delay || 0;
                  return !0 === L.backwards && (v = c.extend(!0, [], v).reverse()), c.each(v, function (e, t) {
                    parseFloat(L.stagger) ? L.delay = O + parseFloat(L.stagger) * e : f.isFunction(L.stagger) && (L.delay = O + L.stagger.call(t, e, C)), L.drag && (L.duration = parseFloat(k) || (/^(callout|transition)/.test(y) ? 1e3 : m), L.duration = Math.max(L.duration * (L.backwards ? 1 - e / C : (e + 1) / C), .75 * L.duration, 200)), g.Redirects[y].call(t, t, L || {}, e, C, v, A.promise ? A : n);
                  }), e();
                }
          ...
          var M,
            ...
            vhToPx: null
              ...
              V = [];
          if (c.each(v, function (e, t) {
            f.isNode(t) && r.call(t);
          }), (L = c.extend({}, g.defaults, x)).loop = parseInt(L.loop), M = 2 * L.loop - 1, L.loop) for (var $ = 0; M > $; $++) {
            var R = {
              delay: L.delay,
              progress: L.progress
            };
            $ === M - 1 && (R.display = L.display, R.visibility = L.visibility, R.complete = L.complete), w(v, "reverse", R);
          }
          return e();
        }
      };

      (g = c.extend(w, g)).animate = w;
      var x = t.requestAnimationFrame || p;
      return g.State.isMobile || i.hidden === n || i.addEventListener("visibilitychange", function () {
        i.hidden ? (x = function x(e) {
          return setTimeout(function () {
            e(!0);
          }, 16);
        }, l()) : x = t.requestAnimationFrame || p;
      }), e.Velocity = g, e !== t && (e.fn.velocity = w, e.fn.velocity.defaults = g.defaults), c.each(["Down", "Up"], function (e, t) {
        ...
        g.Redirects["fade" + t] = function (e, i, o, a, r, s) {
          ...
          l.complete = o !== a - 1 ? l.begin = null : function () {
            d && d.call(r, r), s && s.resolver(r);
          }, l.display === n && (l.display = "In" === t ? "auto" : "none"), g(this, u, l);
        };
      }), g;
    }
...
$(window).scroll(function () {
  ...
  "function" == typeof define && define.amd ? define([], function () {
    return t.apply(e);
  }) : "object" == (typeof exports === "undefined" ? "undefined" : _typeof2(exports)) ? module.exports = t.call(e) : e.Waves = t.call(e);
}("object" == (typeof global === "undefined" ? "undefined" : _typeof2(global)) ? global : void 0, function () {
  "use strict";
  ...
  var l = {
    ...
    show: function show(e, t, i) {
      ...
      var o = r(t),
          a = 0,
          u = 0;
      "touches" in e && e.touches.length ? (a = e.touches[0].pageY - o.top, u = e.touches[0].pageX - o.left) : (a = e.pageY - o.top, u = e.pageX - o.left), u = u >= 0 ? u : 0, a = a >= 0 ? a : 0;
      var c = "scale(" + t.clientWidth / 100 * 3 + ")",
          d = "translate(0,0)";
      i && (d = "translate(" + i.x + "px, " + i.y + "px)"), n.setAttribute("data-hold", Date.now()), n.setAttribute("data-x", u), n.setAttribute("data-y", a), n.setAttribute("data-scale", c), n.setAttribute("data-translate", d);
      var p = {
        top: a + "px",
        left: u + "px"
      };
      n.classList.add("waves-notransition"), n.setAttribute("style", s(p)), n.classList.remove("waves-notransition"), p["-webkit-transform"] = c + " " + d, p["-moz-transform"] = c + " " + d, p["-ms-transform"] = c + " " + d, p["-o-transform"] = c + " " + d, p.transform = c + " " + d, p.opacity = "1";
      var f = "mousemove" === e.type ? 2500 : l.duration;
      p["-webkit-transition-duration"] = f + "ms", p["-moz-transition-duration"] = f + "ms", p["-o-transition-duration"] = f + "ms", p["transition-duration"] = f + "ms", n.setAttribute("style", s(p));
    },
    hide: function hide(e, t) {
      for (var i = (t = t || this).getElementsByClassName("waves-rippling"), n = 0, o = i.length; n < o; n++) {
        c(e, t, i[n]);
      }
    }
  },
    ...
    if (null !== t) {
      ...
      if (d.registerEvent(e), "touchstart" === e.type && l.delay) {
        ...
        t.addEventListener("touchmove", function (e) {
          o && (clearTimeout(o), o = null), a(e);
        }, !1), t.addEventListener("touchend", a, !1), t.addEventListener("touchcancel", a, !1);
  ...
  return e.init = function (e) {
    ...
    for (var r = 0, s = e.length; r < s; r++) {
      o = (n = e[r]).tagName.toLowerCase(), -1 !== ["input", "img"].indexOf(o) && (u[o](n), n = n.parentElement), -1 === n.className.indexOf("waves-effect") && (n.className += " waves-effect" + t);
    }
  }, e.ripple = function (e, t) {
    var i = (e = a(e)).length;
    if ((t = t || {}).wait = t.wait || 0, t.position = t.position || null, i) for (var n, o, s, u = {}, c = 0, d = {
      type: "mousedown",
      button: 1
    }, p = function p(e, t) {
      return function () {
      ...
      if (n = e[c], o = t.position || {
        x: n.clientWidth / 2,
        y: n.clientHeight / 2
      }, s = r(n), u.x = s.left + o.x, u.y = s.top + o.y, d.pageX = u.x, d.pageY = u.y, l.show(d, n), t.wait >= 0 && null !== t.wait) {
        setTimeout(p({
          type: "mouseup",
          button: 1
        }, n), t.wait);
  ...
  e(document).ready(function () {
    var t = ["text", "password", "email", "url", "tel", "number", "search", "search-md"].map(function (e) {
      ...
      if (e.hasClass("validate")) {
        ...
        if (i && n) e.removeClass("valid").removeClass("invalid");else {
          var o = e.is(":valid"),
    ...
    if (e(t).each(function (t, n) {
      ...
      var a;
      a = window.attachEvent ? function (e, t, i) {
        ...
        a(e, "change", t), a(e, "cut", i), a(e, "paste", i), a(e, "drop", i), a(e, "keydown", i), t();
      });
    }
...
$(".smooth-scroll").on("click", "a", function () {
  ...
  e.fn.scrollTo = function (t) {
    ...
    this.each(function () {
      ...
      function l(t) {
        "focus" === t && (a = !0), s(), r.addClass("active"), n.addClass("active"), !0 === o.constrain_width ? r.css("width", n.outerWidth()) : r.css("white-space", "nowrap");
        var i = window.innerHeight,
            l = n.innerHeight(),
            u = n.offset().left,
        ...
        var m = 0,
            v = n.parent();
        if (!v.is("body") && v[0].scrollHeight > v[0].clientHeight && (m = v[0].scrollTop), u + r.innerWidth() > e(window).width() ? d = "right" : u - r.innerWidth() + n.innerWidth() < 0 && (d = "left"), c + r.innerHeight() > i) if (c + l - r.innerHeight() < 0) {
          var g = i - c - h;
          r.css("max-height", g);
        } else h || (h += l), h -= r.innerHeight();
        if ("left" === d) p = o.gutter, f = n.position().left + p;else if ("right" === d) {
          f = n.position().left + n.outerWidth() - r.outerWidth() + (p = -o.gutter);
        }
        r.css({
          position: "absolute",
          top: n.position().top + h + m,
          left: f
      ...
      if (s(), n.after(r), o.hover) {
        ...
        n.unbind("click." + n.attr("id")), n.on("mouseenter", function () {
          ...
          e(i).closest(".dropdown-content").is(r) || (r.stop(!0, !0), u(), c = !1);
        }), r.on("mouseleave", function (t) {
          var i = t.toElement || t.relatedTarget;
          e(i).closest(".dropdown-button").is(n) || (r.stop(!0, !0), u(), c = !1);
        });
      } else n.unbind("click." + n.attr("id")), n.bind("click." + n.attr("id"), function (t) {
        a || (n[0] !== t.currentTarget || n.hasClass("active") || 0 !== e(t.target).closest(".dropdown-content").length ? n.hasClass("active") && (u(), e(document).unbind("click." + r.attr("id") + " touchstart." + r.attr("id"))) : (t.preventDefault(), l("click")), r.hasClass("active") && e(document).bind("click." + r.attr("id") + " touchstart." + r.attr("id"), function (t) {
          r.is(t.target) || n.is(t.target) || n.find(t.target).length || (u(), e(document).unbind("click." + r.attr("id") + " touchstart." + r.attr("id")));
        }));
      });
...
dropdownSelectors.on({
  ...
  function f(e, t, i) {
    var o;
    if (e) if (e.forEach) e.forEach(t, i);else if (e.length !== n) for (o = 0; o < e.length;) {
      t.call(i, e[o], o, e), o++;
    } else for (o in e) {
  ...
  function h(t, i, n) {
    ...
    return function () {
      ...
      return a && a.call(e.console, o, n), t.apply(this, arguments);
    };
  }
  ...
  var m = h(function (e, t, i) {
    for (var o = Object.keys(t), a = 0; a < o.length;) {
      (!i || i && e[o[a]] === n) && (e[o[a]] = t[o[a]]), a++;
    }
  ...
  function g(e, t, i) {
    var n,
        a = t.prototype;
    (n = e.prototype = Object.create(a)).constructor = e, n._super = a, i && o(n, i);
  }
  ...
  function b(e, t) {
    return _typeof2(e) == s ? e.apply(t && t[0] || n, t) : e;
  }
  ...
  function k(e, t) {
    for (var i, o, r = t[0].toUpperCase() + t.slice(1), s = 0; s < a.length;) {
      if ((o = (i = a[s]) ? i + r : t) in e) return o;
      s++;
    }
  ...
  function G(e, t, i) {
    var o = i.pointers.length,
        ...
        r = t & $ && o - a == 0,
        s = t & (_ | z) && o - a == 0;
    i.isFirst = !!r, i.isFinal = !!s, r && (e.session = {}), i.eventType = t, function (e, t) {
      var i = e.session,
          o = t.pointers,
          a = o.length;
      i.firstInput || (i.firstInput = K(t));
      a > 1 && !i.firstMultiple ? i.firstMultiple = K(t) : 1 === a && (i.firstMultiple = !1);
      var r = i.firstInput,
          s = i.firstMultiple,
          l = s ? s.center : r.center,
          d = t.center = J(o);
      t.timeStamp = c(), t.deltaTime = t.timeStamp - r.timeStamp, t.angle = ne(l, d), t.distance = ie(l, d), function (e, t) {
        var i = t.center,
            n = e.offsetDelta || {},
            o = e.prevDelta || {},
            a = e.prevInput || {};
        t.eventType !== $ && a.eventType !== _ || (o = e.prevDelta = {
          x: a.deltaX || 0,
          y: a.deltaY || 0
        }, n = e.offsetDelta = {
          x: i.x,
      ...
      t.overallVelocityX = p.x, t.overallVelocityY = p.y, t.overallVelocity = u(p.x) > u(p.y) ? p.x : p.y, t.scale = s ? (f = s.pointers, h = o, ie(h[0], h[1], U) / ie(f[0], f[1], U)) : 1, t.rotation = s ? function (e, t) {
        return ne(t[1], t[0], U) + ne(e[1], e[0], U);
      }(s.pointers, o) : 0, t.maxPointers = i.prevInput ? t.pointers.length > i.prevInput.maxPointers ? t.pointers.length : i.prevInput.maxPointers : t.pointers.length, function (e, t) {
        var i,
            o,
            a,
            r,
        ...
        if (t.eventType != z && (l > V || s.velocity === n)) {
          var c = t.deltaX - s.deltaX,
              d = t.deltaY - s.deltaY,
              p = ee(l, c, d);
          o = p.x, a = p.y, i = u(p.x) > u(p.y) ? p.x : p.y, r = te(c, d), e.lastInterval = t;
        } else i = s.velocity, o = s.velocityX, a = s.velocityY, r = s.direction;

        t.velocity = i, t.velocityX = o, t.velocityY = a, t.direction = r;
      }(i, t);
      var f, h;
      var m = e.element;
  ...
  function te(e, t) {
    return e === t ? N : u(e) >= u(t) ? e < 0 ? j : H : t < 0 ? W : Y;
  }
  ...
  function se() {
    this.evEl = ae, this.evWin = re, this.pressed = !1, Q.apply(this, arguments);
  }

  g(se, Q, {
    handler: function handler(e) {
      var t = oe[e.type];
      t & $ && 0 === e.button && (this.pressed = !0), t & R && 1 !== e.which && (t = _), this.pressed && (t & _ && (this.pressed = !1), this.callback(this.manager, t, {
        pointers: [e],
        changedPointers: [e],
        pointerType: "mouse",
        srcEvent: e
  ...
  function pe() {
    this.evEl = ce, this.evWin = de, Q.apply(this, arguments), this.store = this.manager.session.pointerEvents = [];
  }

  e.MSPointerEvent && !e.PointerEvent && (ce = "MSPointerDown", de = "MSPointerMove MSPointerUp MSPointerCancel"), g(pe, Q, {
    handler: function handler(e) {
      var t = this.store,
          i = !1,
          n = e.type.toLowerCase().replace("ms", ""),
          o = le[n],
          a = ue[e.pointerType] || e.pointerType,
          r = "touch" == a,
          s = I(t, e.pointerId, "pointerId");
      o & $ && (0 === e.button || r) ? s < 0 && (t.push(e), s = t.length - 1) : o & (_ | z) && (i = !0), s < 0 || (t[s] = e, this.callback(this.manager, o, {
        pointers: t,
        changedPointers: [e],
        pointerType: a,
        srcEvent: e
  ...
  function ve() {
    this.evTarget = he, this.evWin = me, this.started = !1, Q.apply(this, arguments);
  }
    ...
    handler: function handler(e) {
      ...
      if (t === $ && (this.started = !0), this.started) {
        var i = function (e, t) {
          ...
          t & (_ | z) && (i = P(i.concat(n), "identifier", !0));
          return [i, n];
        }.call(this, e, t);

        t & (_ | z) && i[0].length - i[1].length == 0 && (this.started = !1), this.callback(this.manager, t, {
          pointers: i[0],
          changedPointers: i[1],
          pointerType: "touch",
          srcEvent: e
  ...
  g(be, Q, {
    handler: function handler(e) {
      var t = ge[e.type],
        ...
        var i = A(e.touches),
            n = this.targetIds;
        if (t & ($ | R) && 1 === i.length) return n[i[0].identifier] = !0, [i, i];
        var o,
            a,
        ...
        if (a = i.filter(function (e) {
          return C(e.target, l);
        }), t === $) for (o = 0; o < a.length;) {
          n[a[o].identifier] = !0, o++;
        }
        o = 0;

        for (; o < r.length;) {
          n[r[o].identifier] && s.push(r[o]), t & (_ | z) && delete n[r[o].identifier], o++;
        }
  ...
  Me.prototype = {
    set: function set(e) {
      "compute" == e && (e = this.compute()), Ee && this.manager.element.style && De[e] && (this.manager.element.style[Se] = e), this.actions = e.toLowerCase().trim();
    },
    ...
    preventDefaults: function preventDefaults(e) {
      ...
      if (this.manager.session.prevented) t.preventDefault();else {
        ...
        if (!r || !a) return o || a && i & q || r && i & B ? this.preventSrc(t) : void 0;
      }
    },
  ...
  function ze(e) {
    this.options = o({}, this.defaults, e || {}), this.id = O++, this.manager = null, this.options.enable = w(this.options.enable, !0), this.state = Le, this.simultaneous = {}, this.requireFail = [];
  }

  function Ne(e) {
    return e & _e ? "cancel" : e & $e ? "end" : e & Ve ? "move" : e & Fe ? "start" : "";
  }

  function je(e) {
    return e == Y ? "down" : e == W ? "up" : e == j ? "left" : e == H ? "right" : "";
  }
  ...
  ze.prototype = {
    ...
    recognizeWith: function recognizeWith(e) {
      ...
      return t[(e = He(e, this)).id] || (t[e.id] = e, e.recognizeWith(this)), this;
    },
    dropRecognizeWith: function dropRecognizeWith(e) {
      return p(e, "dropRecognizeWith", this) ? this : (e = He(e, this), delete this.simultaneous[e.id], this);
    },
    requireFailure: function requireFailure(e) {
      if (p(e, "requireFailure", this)) return this;
      var t = this.requireFail;
      return -1 === I(t, e = He(e, this)) && (t.push(e), e.requireFailure(this)), this;
    },
    ...
    emit: function emit(e) {
      ...
      i < $e && n(t.options.event + Ne(i)), n(t.options.event), e.additionalEvent && n(e.additionalEvent), i >= $e && n(t.options.event + Ne(i));
    },
    ...
    recognize: function recognize(e) {
      ...
      this.state & (Re | _e | 32) && (this.state = Le), this.state = this.process(t), this.state & (Fe | Ve | $e | _e) && this.tryEmit(t);
    },
    ...
    process: function process(e) {
      var t = this.state,
          ...
          n = t & (Fe | Ve),
          o = this.attrTest(e);
      return n && (i & z || !o) ? t | _e : n || o ? i & _ ? t | $e : t & Fe ? t | Ve : Fe : 32;
    }
  }), g(Ye, We, {
    defaults: {
      event: "pan",
    ...
    getTouchAction: function getTouchAction() {
      var e = this.options.direction,
          t = [];
      return e & q && t.push(Oe), e & B && t.push(ke), t;
    },
    directionTest: function directionTest(e) {
      var t = this.options,
          ...
          a = e.deltaX,
          r = e.deltaY;
      return o & t.direction || (t.direction & q ? (o = 0 === a ? N : a < 0 ? j : H, i = a != this.pX, n = Math.abs(e.deltaX)) : (o = 0 === r ? N : r < 0 ? W : Y, i = r != this.pY, n = Math.abs(e.deltaY))), e.direction = o, i && n > t.threshold && o & t.direction;
    },
    attrTest: function attrTest(e) {
      return We.prototype.attrTest.call(this, e) && (this.state & Fe || !(this.state & Fe) && this.directionTest(e));
    },
    emit: function emit(e) {
    ...
    process: function process(e) {
      ...
      if (this._input = e, !n || !i || e.eventType & (_ | z) && !o) this.reset();else if (e.eventType & $) this.reset(), this._timer = d(function () {
        this.state = Re, this.tryEmit();
      }, t.time, this);else if (e.eventType & _) return Re;
      return 32;
    },
    reset: function reset() {
    ...
    emit: function emit(e) {
      this.state === Re && (e && e.eventType & _ ? this.manager.emit(this.options.event + "up", e) : (this._input.timeStamp = c(), this.manager.emit(this.options.event, this._input)));
    }
  }), g(Xe, We, {
    defaults: {
      event: "rotate",
    ...
    attrTest: function attrTest(e) {
      ...
      return i & (q | B) ? t = e.overallVelocity : i & q ? t = e.overallVelocityX : i & B && (t = e.overallVelocityY), this._super.attrTest.call(this, e) && i & e.offsetDirection && e.distance > this.options.threshold && e.maxPointers == this.options.pointers && u(t) > this.options.velocity && e.eventType & _;
    },
    emit: function emit(e) {
    ...
    process: function process(e) {
      ...
      if (n && o && i) {
        ...
        if (this.pTime = e.timeStamp, this.pCenter = e.center, r && a ? this.count += 1 : this.count = 1, this._input = e, 0 === this.count % t.taps) return this.hasRequireFailures() ? (this._timer = d(function () {
          this.state = Re, this.tryEmit();
        }, t.interval, this), Fe) : Re;
      }
  ...
  function Ge(e, t) {
    var i;
    this.options = o({}, Qe.defaults, t || {}), this.options.inputTarget = this.options.inputTarget || e, this.handlers = {}, this.session = {}, this.recognizers = [], this.oldCssProps = {}, this.element = e, this.input = new ((i = this).options.inputClass || (L ? pe : F ? be : M ? Te : se))(i, G), this.touchAction = new Me(this, this.options.touchAction), Ke(this, !0), f(this.options.recognizers, function (e) {
  ...
  function Ke(e, t) {
    var i,
        n = e.element;
    n.style && (f(e.options.cssProps, function (o, a) {
      i = k(n.style, a), t ? (e.oldCssProps[i] = n.style[i], n.style[i] = o) : n.style[i] = e.oldCssProps[i] || "";
    }), t || (e.oldCssProps = {}));
  }
  ...
  Ge.prototype = {
    ...
    recognize: function recognize(e) {
      ...
      if (!t.stopped) {
        ...
        var n = this.recognizers,
            o = t.curRecognizer;
        (!o || o && o.state & Re) && (o = t.curRecognizer = null);

        for (var a = 0; a < n.length;) {
          i = n[a], 2 === t.stopped || o && i != o && !i.canRecognizeWith(o) ? i.reset() : i.recognize(e), !o && i.state & (Fe | Ve | $e) && (o = t.curRecognizer = i), a++;
        }
      }
    },
    get: function get(e) {
    ...
    off: function off(e, t) {
      if (e !== n) {
        var i = this.handlers;
        return f(E(e), function (e) {
          t ? i[e] && i[e].splice(I(i[e], t), 1) : delete i[e];
        }), this;
      }
    },
    emit: function emit(e, i) {
  ...
  "function" == typeof define && define.amd ? define(["jquery", "hammerjs"], e) : "object" == (typeof exports === "undefined" ? "undefined" : _typeof2(exports)) ? e(require("jquery"), require("hammerjs")) : e(jQuery, Hammer);
}(function (e, t) {
  var i;
  ...
  e(document).on("change", t, function () {
    ...
    if (!r.length && function () {
      var i = e('<span class="thumb"><span class="value"></span></span>');
      e(t).after(i);
      ...
      (n = l ? o.originalEvent.touches[0].pageX - e(this).offset().left : o.pageX - e(this).offset().left) < 0 ? n = 0 : n > s && (n = s), r.addClass("active").css("left", n);
    }
    ...
    if (i) {
      o.hasClass("active") || o.velocity({
        ...
        duration: 300,
        easing: "easeOutExpo"
      }), a = void 0 === n.pageX || null === n.pageX ? n.originalEvent.touches[0].pageX - e(this).offset().left : n.pageX - e(this).offset().left;
      var r = e(this).outerWidth();
      a < 0 ? a = 0 : a > r && (a = r), o.addClass("active").css("left", a), o.find(".value").html(o.siblings(t).val());
    }
  ...
  e.fn.material_select = function (t) {
    function i(e, t, i) {
      var n = e.indexOf(t),
          o = -1 === n;
      return o ? e.push(t) : e.splice(n, 1), i.siblings("ul.dropdown-content").find("li:not(.optgroup)").eq(t).toggleClass("active"), i.find("option").eq(t).prop("selected", o), function (e, t) {
    ...
    e(this).each(function () {
      ...
      if (!n.hasClass("browser-default")) {
        ...
        if (a && (n.parent().find("span.caret").remove(), n.parent().find("input").remove(), n.unwrap(), e("ul#select-options-" + a).remove()), "destroy" !== t) {
          var r,
              s = (r = new Date().getTime(), "xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx".replace(/[xy]/g, function (e) {
          ...
          g && (u = n.attr("searchable"), c = e('<span class="search-wrap"><div class="md-form"><input type="text" class="search form-control" placeholder="' + u + '"></div></span>'), d.append(c), c.find(".search").keyup(v));

          var y = function y(t, i, n) {
            ...
            if (r) {
              var l = "";
              return s && (l = ' class="' + s + '"'), "multiple" === n ? d.append(e('<li class="' + o + '"><img alt="" src="' + r + '"' + l + '><span class="filtrable"><input type="checkbox"' + o + "/><label></label>" + i.html() + "</span></li>")) : d.append(e('<li class="' + o + a + '"><img alt="" src="' + r + '"' + l + '><span class="filtrable">' + i.html() + "</span></li>")), !0;
            }

            "multiple" === n ? d.append(e('<li class="' + o + '"><span class="filtrable"><input type="checkbox"' + o + "/><label></label>" + i.html() + "</span></li>")) : d.append(e('<li class="' + o + a + '"><span class="filtrable">' + i.html() + "</span></li>"));
          };
            ...
            e(this).click(function (r) {
              if (!e(this).hasClass("disabled") && !e(this).hasClass("optgroup")) {
                ...
                o ? (e('input[type="checkbox"]', this).prop("checked", function (e, t) {
                  return !t;
                }), s = i(f, g ? b ? e(this).index() - e(this).prevAll(".optgroup").length - 1 : e(this).index() - 1 : b ? e(this).index() - e(this).prevAll(".optgroup").length : e(this).index(), n), C.trigger("focus")) : (d.find("li").removeClass("active"), e(this).toggleClass("active"), C.val(e(this).text())), S(d, e(this)), n.find("option").eq(a).prop("selected", s), n.trigger("change"), void 0 !== t && t();
              }
          ...
          var T = m.replace(/"/g, "&quot;"),
              C = e('<input type="text" class="select-dropdown" readonly="true" ' + (n.is(":disabled") ? "disabled" : "") + ' data-activates="select-options-' + s + '" value="' + T + '"/>');
          n.before(C), C.before(x), C.after(d), n.is(":disabled") || C.dropdown({
            hover: !1,
            closeOnClick: !1
          }), n.attr("tabindex") && e(C[0]).attr("tabindex", n.attr("tabindex")), n.addClass("initialized"), C.on({
              ...
              if (40 != t.which || d.is(":visible")) {
                if (13 != t.which || d.is(":visible")) {
                  ...
                  if (13 == t.which) {
                    ...
                    r && (e(r).trigger("click"), o || C.trigger("close"));
                  }

                  40 == t.which && (a = d.find("li.selected").length ? d.find("li.selected").next("li:not(.disabled)")[0] : d.find("li:not(.disabled)")[0], S(d, a)), 27 == t.which && C.trigger("close"), 38 == t.which && (a = d.find("li.selected").prev("li:not(.disabled)")[0]) && S(d, a), setTimeout(function () {
                    E = [];
                  }, 1e3);
                }
              } else C.trigger("open");
  ...
  "function" == typeof define && define.amd ? define(t) : "object" == (typeof exports === "undefined" ? "undefined" : _typeof2(exports)) ? module.exports = t() : e.PhotoSwipe = t();
}(void 0, function () {
  "use strict";
  ...
  return function (e, t, i, n) {
    var o = {
      ...
      arraySearch: function arraySearch(e, t, i) {
      ...
      detectFeatures: function detectFeatures() {
        ...
        for (var l, u, c = ["transform", "perspective", "animationName"], d = ["", "webkit", "Moz", "ms", "O"], p = 0; 4 > p; p++) {
          t = d[p];

          for (var f = 0; 3 > f; f++) {
            l = c[f], u = t + (t ? l.charAt(0).toUpperCase() + l.slice(1) : l), !i[l] && u in e && (i[l] = u);
          }
    ...
    o.detectFeatures(), o.features.oldIE && (o.bind = function (e, t, i, n) {
      ...
      for (var o, a = (n ? "detach" : "attach") + "Event", r = function r() {
        i.handleEvent.call(i);
      }, s = 0; s < t.length; s++) {
        if (o = t[s]) if ("object" == _typeof2(i) && i.handleEvent) {
          if (n) {
    ...
    var s,
      ...
      ae = e, a.bg.style.opacity = e * r.bgOpacity;
        ...
        Ae = function Ae(e, t, i, n, o) {
      (!be || o && o !== a.currItem) && (n /= o ? o.fitRatio : a.currItem.fitRatio), e[P] = y + t + "px, " + i + "px" + b + " scale(" + n + ")";
    },
        Pe = function Pe(e) {
      ee && (e && (v > a.currItem.fitRatio ? be || (Ut(a.currItem, !1, !0), be = !0) : be && (Ut(a.currItem), be = !1)), Ae(ee, ce.x, ce.y, v));
    },
        ke = function ke(e) {
      ...
      t[P] = y + e + "px, 0px" + b;
        ...
        De = function De(e, t) {
      if (!r.loop && t) {
        var i = c + (he.x * pe - e) / he.x,
            n = Math.round(e - ut.x);
        (0 > i && n > 0 || i >= Nt() - 1 && 0 > n) && (e = ut.x + n * r.mainScrollEndFriction);
      }
      ...
      e.x = Math.round(e.x), e.y = Math.round(e.y);
        ...
        Ve = null,
        $e = function $e() {
      Ve && (o.unbind(document, "mousemove", $e), o.addClass(e, "pswp--has_mouse"), r.mouseUsed = !0, Se("mouseUsed")), Ve = setTimeout(function () {
        Ve = null;
      }, 100);
    },
        Re = function Re(e, t) {
      var i = qt(a.currItem, de, e);
      return t && (J = i), i;
    },
        _e = function _e(e) {
      ...
      r.escKey && 27 === e.keyCode ? t = "close" : r.arrowKeys && (37 === e.keyCode ? t = "prev" : 39 === e.keyCode && (t = "next")), t && (e.ctrlKey || e.altKey || e.shiftKey || e.metaKey || (e.preventDefault ? e.preventDefault() : e.returnValue = !1, a[t]()));
        ...
        He = function He(e) {
      e && (X || B || te || H) && (e.preventDefault(), e.stopPropagation());
    },
        We = function We() {
      a.setScrollOffset(0, o.getScrollY());
        ...
        qe = 0,
        Be = function Be(e) {
      Ye[e] && (Ye[e].raf && M(Ye[e].raf), qe--, delete Ye[e]);
    },
        Xe = function Xe(e) {
      Ye[e] && Be(e), Ye[e] || (qe++, Ye[e] = {});
    },
        Ze = function Ze() {
      for (var e in Ye) {
        Ye.hasOwnProperty(e) && Be(e);
      }
    },
        Ue = function Ue(e, t, i, n, o, a, r) {
      var s,
          l = Ee();
      Xe(e);
      ...
      var u = function u() {
        if (Ye[e]) {
          if ((s = Ee() - l) >= n) return Be(e), a(i), void (r && r());
          a((i - t) * o(s / n) + t), Ye[e].raf = D(u);
        }
      };
      ...
      setScrollOffset: function setScrollOffset(e, t) {
        fe.x = e, $ = fe.y = t, Se("updateScrollOffset", fe);
      },
      applyZoomPan: function applyZoomPan(e, t, i, n) {
        ce.x = t, ce.y = i, v = e, Pe(n);
      },
      init: function init() {
        if (!s && !l) {
          var i;
          a.framework = o, a.template = e, a.bg = o.getChildByClass(e, "pswp__bg"), L = e.className, s = !0, R = o.detectFeatures(), D = R.raf, M = R.caf, P = R.transform, V = R.oldIE, a.scrollWrap = o.getChildByClass(e, "pswp__scroll-wrap"), a.container = o.getChildByClass(a.scrollWrap, "pswp__container"), d = a.container.style, a.itemHolders = T = [{
            ...
            P = "left", o.addClass(e, "pswp--ie"), Oe = function Oe(e, t) {
              t.left = e + "px";
            }, ke = function ke(e) {
              ...
              if (ee) {
                var e = ee,
                    ...
                    n = i * t.w,
                    o = i * t.h;
                e.width = n + "px", e.height = o + "px", e.left = ce.x + "px", e.top = ce.y + "px";
              }
            };
          }(), m = {
            resize: a.updateSize,
          ...
          for (R.animationName && R.transform && !n || (r.showAnimationDuration = r.hideAnimationDuration = 0), i = 0; i < ge.length; i++) {
            a["init" + ge[i]]();
          }

          t && (a.ui = new t(a, o)).init(), Se("firstUpdate"), c = c || r.index || 0, (isNaN(c) || 0 > c || c >= Nt()) && (c = 0), a.currItem = zt(c), (R.isOldIOSPhone || R.isOldAndroid) && (ve = !1), e.setAttribute("aria-hidden", "false"), r.modal && (ve ? e.style.position = "fixed" : (e.style.position = "absolute", e.style.top = o.getScrollY() + "px")), void 0 === $ && (Se("initialLayout"), $ = F = o.getScrollY());
          var u = "pswp--open ";

          for (r.mainClass && (u += r.mainClass + " "), r.showHideOpacity && (u += "pswp--animate_opacity "), u += O ? "pswp--touch" : "pswp--notouch", u += R.animationName ? " pswp--css_animation" : "", u += R.svg ? " pswp--svg" : "", o.addClass(e, u), a.updateSize(), p = -1, me = null, i = 0; 3 > i; i++) {
            Oe((i + p) * he.x, T[i].el.style);
          }

          V || o.bind(a.scrollWrap, h, a), Ce("initialZoomInEnd", function () {
            a.setContent(T[0], c - 1), a.setContent(T[2], c + 1), T[0].el.style.display = T[2].el.style.display = "block", r.focus && e.focus(), o.bind(document, "keydown", a), R.transform && o.bind(a.scrollWrap, "click", a), r.mouseUsed || o.bind(document, "mousemove", $e), o.bind(window, "resize scroll", a), Se("bindEvents");
          }), a.setContent(T[1], c), a.updateCurrItem(), Se("afterInit"), ve || (w = setInterval(function () {
            qe || Y || G || v !== a.currItem.initialZoomLevel || a.updateSize();
          }, 1e3)), o.addClass(e, "pswp--visible");
        }
      },
      close: function close() {
        s && (s = !1, l = !0, Se("close"), o.unbind(window, "resize", a), o.unbind(window, "scroll", m.scroll), o.unbind(document, "keydown", a), o.unbind(document, "mousemove", $e), R.transform && o.unbind(a.scrollWrap, "click", a), Y && o.unbind(window, f, a), Se("unbindEvents"), jt(a.currItem, null, !0, a.destroy));
      },
      destroy: function destroy() {
        Se("destroy"), Vt && clearTimeout(Vt), e.setAttribute("aria-hidden", "true"), e.className = L, w && clearInterval(w), o.unbind(a.scrollWrap, h, a), o.unbind(window, "scroll", a), ft(), Ze(), Te = null;
      },
      panTo: function panTo(e, t, i) {
        i || (e > J.min.x ? e = J.min.x : e < J.max.x && (e = J.max.x), t > J.min.y ? t = J.min.y : t < J.max.y && (t = J.max.y)), ce.x = e, ce.y = t, Pe();
      },
      ...
      goTo: function goTo(e) {
        var t = (e = xe(e)) - c;
        me = t, c = e, a.currItem = zt(c), pe -= t, De(he.x * pe), Ze(), te = !1, a.updateCurrItem();
      },
      next: function next() {
        a.goTo(c + 1);
      },
      ...
      updateCurrZoomItem: function updateCurrZoomItem(e) {
        ...
        J = a.currItem.bounds, g = v = a.currItem.initialZoomLevel, ce.x = J.center.x, ce.y = J.center.y, e && Se("afterChange");
      },
      ...
      updateCurrItem: function updateCurrItem(e) {
        if (0 !== me) {
          ...
          if (!(e && 2 > i)) {
            a.currItem = zt(c), be = !1, Se("beforeChange", me), i >= 3 && (p += me + (me > 0 ? -3 : 3), i = 3);

            for (var n = 0; i > n; n++) {
              me > 0 ? (t = T.shift(), T[2] = t, Oe((++p + 2) * he.x, t.el.style), a.setContent(t, c - i + n + 1 + 1)) : (t = T.pop(), T.unshift(t), Oe(--p * he.x, t.el.style), a.setContent(t, c + i - n - 1 - 1));
            }

            if (ee && 1 === Math.abs(me)) {
              var o = zt(C);
              o.initialZoomLevel !== v && (qt(o, de), Ut(o), ke(o));
            }

            me = 0, a.updateCurrZoomItem(), C = c, Se("afterChange");
          }
        }
      },
      updateSize: function updateSize(t) {
        ...
        if (de.x = a.scrollWrap.clientWidth, de.y = a.scrollWrap.clientHeight, We(), he.x = de.x + Math.round(de.x * r.spacing), he.y = de.y, De(he.x * pe), Se("beforeResize"), void 0 !== p) {
          for (var n, s, l, u = 0; 3 > u; u++) {
            n = T[u], Oe((u + p) * he.x, n.el.style), l = c + u - 1, r.loop && Nt() > 2 && (l = xe(l)), (s = zt(l)) && (x || s.needsUpdate || !s.bounds) ? (a.cleanSlide(s), a.setContent(n, l), 1 === u && (a.currItem = s, a.updateCurrZoomItem(!0)), s.needsUpdate = !1) : -1 === n.index && l >= 0 && a.setContent(n, l), s && s.container && (qt(s, de), Ut(s), ke(s));
          }

          x = !1;
        }

        g = v = a.currItem.initialZoomLevel, (J = a.currItem.bounds) && (ce.x = J.center.x, ce.y = J.center.y, Pe(!0)), Se("resize");
      },
      zoomTo: function zoomTo(e, t, i, n, a) {
        t && (g = v, ct.x = Math.abs(t.x) - ce.x, ct.y = Math.abs(t.y) - ce.y, Le(ue, ce));
        var r = Re(e, !1),
            s = {};
        Ne("x", r, s, e), Ne("y", r, s, e);
        var l = v,
            u = ce.x,
            c = ce.y;
        Fe(s);
        ...
        var d = function d(t) {
          1 === t ? (v = e, ce.x = s.x, ce.y = s.y) : (v = (e - l) * t + l, ce.x = (s.x - u) * t + u, ce.y = (s.y - c) * t + c), a && a(t), Pe(1 === t);
        };

        i ? Ue("customZoomTo", 0, 1, i, n || o.easing.sine.inOut, d) : d(1);
      }
    },
        Ge = {},
        Ke = {},
      ...
      return !(!e || e === document) && !(e.getAttribute("class") && e.getAttribute("class").indexOf("pswp__scroll-wrap") > -1) && (t(e) ? e : mt(e.parentNode, t));
        ...
        vt = {},
        gt = function gt(e, t) {
      return vt.prevent = !mt(e.target, r.isClickableElement), Se("preventDragEvent", e, t, vt), vt.prevent;
    },
        yt = function yt(e, t) {
      return t.x = e.pageX, t.y = e.pageY, t.id = e.identifier, t;
    },
        bt = function bt(e, t, i) {
      i.x = .5 * (e.x + t.x), i.y = .5 * (e.y + t.y);
    },
        wt = function wt() {
      var e = ce.y - a.currItem.initialPosition.y;
      ...
      return k ? (se = 0, it.forEach(function (e) {
        0 === se ? Ct[0] = e : 1 === se && (Ct[1] = e), se++;
      })) : e.type.indexOf("touch") > -1 ? e.touches && e.touches.length > 0 && (Ct[0] = yt(e.touches[0], xt), e.touches.length > 1 && (Ct[1] = yt(e.touches[1], Tt))) : (xt.x = e.pageX, xt.y = e.pageY, xt.id = "", Ct[0] = xt), Ct;
    },
        Et = function Et(e, t) {
      var i,
          n,
          ...
          c = ut.x + t.x,
          d = ut.x - nt.x;
      return i = l > J.min[e] || l < J.max[e] ? r.panEndFriction : 1, l = ce[e] + t[e] * i, !r.allowPanToNext && v !== a.currItem.initialZoomLevel || (ee ? "h" !== ie || "x" !== e || B || (u ? (l > J.min[e] && (i = r.panEndFriction, J.min[e], n = J.min[e] - ue[e]), (0 >= n || 0 > d) && Nt() > 1 ? (s = c, 0 > d && c > nt.x && (s = nt.x)) : J.min.x !== J.max.x && (o = l)) : (l < J.max[e] && (i = r.panEndFriction, J.max[e], n = ue[e] - J.max[e]), (0 >= n || d > 0) && Nt() > 1 ? (s = c, d > 0 && c < nt.x && (s = nt.x)) : J.min.x !== J.max.x && (o = l))) : s = c, "x" !== e) ? void (te || U || v > a.currItem.fitRatio && (ce[e] += t[e] * i)) : (void 0 !== s && (De(s, !0), U = s !== nt.x), J.min.x !== J.max.x && (void 0 !== o ? ce.x = o : U || (ce.x += t.x * i)), void 0 !== s);
    },
        It = function It(e) {
      if (!("mousedown" === e.type && e.button > 0)) {
        ...
        if (!W || "mousedown" !== e.type) {
          if (gt(e, !0) && e.preventDefault(), Se("pointerDown"), k) {
          ...
          var i = St(e),
              n = i.length;
          Q = null, Ze(), Y && 1 !== n || (Y = ne = !0, o.bind(window, f, a), j = re = oe = H = U = X = q = B = !1, ie = null, Se("firstTouchStart", i), Le(ue, ce), le.x = le.y = 0, Le(et, i[0]), Le(tt, et), nt.x = he.x * pe, ot = [{
            x: et.x,
            y: et.y
          }], z = _ = Ee(), Re(v, !0), ft(), ht()), !G && n > 1 && !te && !U && (g = v, B = !1, G = q = !0, le.y = le.x = 0, Le(ue, ce), Le(Ge, i[0]), Le(Ke, i[1]), bt(Ge, Ke, dt), ct.x = Math.abs(dt.x) - ce.x, ct.y = Math.abs(dt.y) - ce.y, K = pt(Ge, Ke));
        }
      }
    },
        At = function At(e) {
      ...
      if (Y) {
        var n = St(e);
        if (ie || X || G) Q = n;else if (ut.x !== he.x * pe) ie = "h";else {
      ...
      if (Q) {
        var e = Q.length;
        if (0 !== e) if (Le(Ge, Q[0]), Je.x = Ge.x - et.x, Je.y = Ge.y - et.y, G && e > 1) {
          if (et.x = Ge.x, et.y = Ge.y, !Je.x && !Je.y && function (e, t) {
            return e.x === t.x && e.y === t.y;
          }(Q[1], Ke)) return;
          Le(Ke, Q[1]), B || (B = !0, Se("zoomGestureStarted"));
          var t = pt(Ge, Ke),
              i = Lt(t);
          ...
          if (o > i) {
            if (r.pinchToClose && !re && g <= a.currItem.initialZoomLevel) {
              var l = 1 - (o - i) / (o / 1.2);
              Ie(l), Se("onPinchClose", l), oe = !0;
            } else (n = (o - i) / o) > 1 && (n = 1), i = o - n * (o / 3);
          } else i > s && ((n = (i - s) / (6 * o)) > 1 && (n = 1), i = s + n * o);
          0 > n && (n = 0), bt(Ge, Ke, st), le.x += st.x - dt.x, le.y += st.y - dt.y, Le(dt, st), ce.x = Me("x", i), ce.y = Me("y", i), j = i > v, v = i, Pe();
        } else {
          if (!ie) return;
          ...
          if ("v" === ie && r.closeOnVerticalDrag && "fit" === r.scaleMode && v === a.currItem.initialZoomLevel) {
            le.y += Je.y, ce.y += Je.y;
            var u = wt();
            return H = !0, Se("onVerticalDrag", u), Ie(u), void Pe();
          }

          (function (e, t, i) {
            if (e - z > 50) {
              var n = ot.length > 2 ? ot.shift() : {};
              n.x = t, n.y = i, ot.push(n), z = e;
            }
          })(Ee(), Ge.x, Ge.y), X = !0, J = a.currItem.bounds, Et("x", Je) || (Et("y", Je), Fe(ce), Pe());
        }
      }
    },
        kt = function kt(e) {
      ...
      if (Se("pointerUp"), gt(e, !1) && e.preventDefault(), k) {
      ...
      var u = -1;
      if (0 === l && (Y = !1, o.unbind(window, f, a), ft(), G ? u = 0 : -1 !== lt && (u = Ee() - lt)), lt = 1 === l ? Ee() : -1, n = -1 !== u && 150 > u ? "zoom" : "swipe", G && 2 > l && (G = !1, 1 === l && (n = "zoomPointerUp"), Se("zoomGestureEnded")), Q = null, X || B || te || H) if (Ze(), N || (N = Ot()), N.calculateSwipeSpeed("x"), H) {
        if (wt() < r.verticalDragRange) a.close();else {
          var c = ce.y,
              d = ae;
          Ue("verticalDrag", 0, 1, 300, o.easing.cubic.out, function (e) {
            ce.y = (a.currItem.initialPosition.y - c) * e + c, Ie((1 - d) * e + d), Pe();
          }), Se("onVerticalDrag", 1);
        }
      } else {
        if ((U || te) && 0 === l) {
        ...
        if (!te) return "swipe" !== n ? void Ft() : void (!U && v > a.currItem.fitRatio && Dt(N));
      }
    },
        Ot = function Ot() {
      var e,
        ...
        calculateSwipeSpeed: function calculateSwipeSpeed(n) {
          ot.length > 1 ? (e = Ee() - z + 50, t = ot[ot.length - 2][n]) : (e = Ee() - _, t = tt[n]), i.lastFlickOffset[n] = et[n] - t, i.lastFlickDist[n] = Math.abs(i.lastFlickOffset[n]), i.lastFlickDist[n] > 20 ? i.lastFlickSpeed[n] = i.lastFlickOffset[n] / e : i.lastFlickSpeed[n] = 0, Math.abs(i.lastFlickSpeed[n]) < .1 && (i.lastFlickSpeed[n] = 0), i.slowDownRatio[n] = .95, i.slowDownRatioReverse[n] = 1 - i.slowDownRatio[n], i.speedDecelerationRatio[n] = 1;
        },
        calculateOverBoundsAnimOffset: function calculateOverBoundsAnimOffset(e, t) {
          i.backAnimStarted[e] || (ce[e] > J.min[e] ? i.backAnimDestination[e] = J.min[e] : ce[e] < J.max[e] && (i.backAnimDestination[e] = J.max[e]), void 0 !== i.backAnimDestination[e] && (i.slowDownRatio[e] = .7, i.slowDownRatioReverse[e] = 1 - i.slowDownRatio[e], i.speedDecelerationRatioAbs[e] < .05 && (i.lastFlickSpeed[e] = 0, i.backAnimStarted[e] = !0, Ue("bounceZoomPan" + e, ce[e], i.backAnimDestination[e], t || 300, o.easing.sine.out, function (t) {
            ce[e] = t, Pe();
          }))));
        },
        ...
        panAnimLoop: function panAnimLoop() {
          return Ye.zoomPan && (Ye.zoomPan.raf = D(i.panAnimLoop), i.now = Ee(), i.timeDiff = i.now - i.lastNow, i.lastNow = i.now, i.calculateAnimOffset("x"), i.calculateAnimOffset("y"), Pe(), i.calculateOverBoundsAnimOffset("x"), i.calculateOverBoundsAnimOffset("y"), i.speedDecelerationRatioAbs.x < .05 && i.speedDecelerationRatioAbs.y < .05) ? (ce.x = Math.round(ce.x), ce.y = Math.round(ce.y), Pe(), void Be("zoomPan")) : void 0;
        }
      };
      return i;
    },
      ...
      if (te || (rt = c), "swipe" === e) {
        ...
        l > 30 && (u || t.lastFlickOffset.x > 20) ? n = -1 : -30 > l && (u || t.lastFlickOffset.x < -20) && (n = 1);
      }

      n && (0 > (c += n) ? (c = r.loop ? Nt() - 1 : 0, s = !0) : c >= Nt() && (c = r.loop ? 0 : Nt() - 1, s = !0), (!s || r.loop) && (me += n, pe -= n, i = !0));
      var d,
          p = he.x * pe,
          f = Math.abs(p - ut.x);
      return i || p > ut.x == t.lastFlickSpeed.x > 0 ? (d = Math.abs(t.lastFlickSpeed.x) > 0 ? f / Math.abs(t.lastFlickSpeed.x) : 333, d = Math.min(d, 400), d = Math.max(d, 250)) : d = 333, rt === c && (i = !1), te = !0, Se("mainScrollAnimStart"), Ue("mainScroll", ut.x, p, d, o.easing.cubic.out, De, function () {
        Ze(), te = !1, rt = -1, (i || rt !== c) && a.updateCurrItem(), Se("mainScrollAnimComplete");
      ...
      var n,
          r = ae;
      return oe && !j && !re && t > v ? (a.close(), !0) : (oe && (n = function n(e) {
        Ie((1 - r) * e + r);
    ...
    we("Gestures", {
      publicMethods: {
        initGestures: function initGestures() {
          var e = function e(_e2, t, i, n, o) {
            S = _e2 + t, E = _e2 + i, I = _e2 + n, A = o ? _e2 + o : "";
          };

          (k = R.pointerEvent) && R.touch && (R.touch = !1), k ? navigator.pointerEnabled ? e("pointer", "down", "move", "up", "cancel") : e("MSPointer", "Down", "Move", "Up", "Cancel") : R.touch ? (e("touch", "start", "move", "end", "cancel"), O = !0) : e("mouse", "down", "move", "up"), f = E + " " + I + " " + A, h = S, k && !O && (O = navigator.maxTouchPoints > 1 || navigator.msMaxTouchPoints > 1), a.likelyTouchDevice = O, m[S] = It, m[E] = At, m[I] = kt, A && (m[A] = m[I]), R.touch && (h += " mousedown", f += " mousemove mouseup", m.mousedown = m[S], m.mousemove = m[E], m.mouseup = m[I]), O || (r.allowPanToNext = !1);
        }
      }
    });
    ...
    var Vt,
        ...
        zt,
        Nt,
        jt = function jt(t, i, n, s) {
      var l;
      Vt && clearTimeout(Vt), _t = !0, Rt = !0, t.initialLayout ? (l = t.initialLayout, t.initialLayout = null) : l = r.getThumbBoundsFn && r.getThumbBoundsFn(c);

      var d = n ? r.hideAnimationDuration : r.showAnimationDuration,
          p = function p() {
        Be("initialZoom"), n ? (a.template.removeAttribute("style"), a.bg.removeAttribute("style")) : (Ie(1), i && (i.style.display = "block"), o.addClass(e, "pswp--animated-in"), Se("initialZoom" + (n ? "OutEnd" : "InEnd"))), s && s(), _t = !1;
      };

      if (!d || !l || void 0 === l.x) return Se("initialZoom" + (n ? "Out" : "In")), v = t.initialZoomLevel, Le(ce, t.initialPosition), Pe(), e.style.opacity = n ? 0 : 1, Ie(1), void (d ? setTimeout(function () {
        p();
      }, d) : p());
      !function () {
        var i = u,
            s = !a.currItem.src || a.currItem.loadError || r.showHideOpacity;
        t.miniImg && (t.miniImg.style.webkitBackfaceVisibility = "hidden"), n || (v = l.w / t.w, ce.x = l.x, ce.y = l.y - F, a[s ? "template" : "bg"].style.opacity = .001, Pe()), Xe("initialZoom"), n && !i && o.removeClass(e, "pswp--animated-in"), s && (n ? o[(i ? "remove" : "add") + "Class"](e, "pswp--animate_opacity") : setTimeout(function () {
          ...
          if (Se("initialZoom" + (n ? "Out" : "In")), n) {
            var a = l.w / t.w,
              ...
              y: ce.y
                ...
                c = ae,
                f = function f(t) {
              1 === t ? (v = a, ce.x = l.x, ce.y = l.y - $) : (v = (a - u) * t + u, ce.x = (l.x - r.x) * t + r.x, ce.y = (l.y - $ - r.y) * t + r.y), Pe(), s ? e.style.opacity = 1 - t : Ie(c - t * c);
            };

            i ? Ue("initialZoom", 0, 1, d, o.easing.cubic.out, f, p) : (f(1), Vt = setTimeout(p, d + 20));
          } else v = t.initialZoomLevel, Le(ce, t.initialPosition), Pe(), Ie(1), s ? e.style.opacity = 1 : Ie(1), Vt = setTimeout(p, d + 20);
        }, n ? 25 : 90);
      }();
    },
        Ht = {},
      ...
      if (e.src && !e.loadError) {
        ...
        if (n && (e.vGap || (e.vGap = {
          top: 0,
          bottom: 0
        }), Se("parseVerticalMargin", e)), Ht.x = t.x, Ht.y = t.y - e.vGap.top - e.vGap.bottom, n) {
          var o = Ht.x / e.w,
              a = Ht.y / e.h;
          e.fitRatio = a > o ? o : a;
          var s = r.scaleMode;
        ...
        return function (e, t, i) {
          var n = e.bounds;
          n.center.x = Math.round((Ht.x - t) / 2), n.center.y = Math.round((Ht.y - i) / 2) + e.vGap.top, n.max.x = t > Ht.x ? Math.round(Ht.x - t) : n.center.x, n.max.y = i > Ht.y ? Math.round(Ht.y - i) + e.vGap.top : n.center.y, n.min.x = t > Ht.x ? 0 : n.center.x, n.min.y = i > Ht.y ? e.vGap.top : n.center.y;
      ...
      return e.w = e.h = 0, e.initialZoomLevel = e.fitRatio = 1, e.bounds = {
        ...
        Bt = function Bt(e, t, i, n, o, r) {
      t.loadError || n && (t.imageAppended = !0, Ut(t, n, t === a.currItem && be), i.appendChild(n), r && setTimeout(function () {
      ...
      if (Wt.length) {
        for (var e, t = 0; t < Wt.length; t++) {
          (e = Wt[t]).holder.index === e.index && Bt(e.index, e.item, e.baseDiv, e.img, 0, e.clearPlaceholder);
        }
    ...
    we("Controller", {
      publicMethods: {
        lazyLoadItem: function lazyLoadItem(e) {
          e = xe(e);
          var t = zt(e);
          t && (!t.loaded && !t.loading || x) && (Se("gettingData", e, t), t.src && Xt(t));
        },
        initController: function initController() {
          o.extend(r, Yt, !0), a.items = $t = i, zt = a.getItemAt, Nt = r.getNumItemsFn, r.loop, Nt() < 3 && (r.loop = !1), Ce("beforeChange", function (e) {
            var t,
                i = r.preload,
                n = null === e || e >= 0,
                o = Math.min(i[0], Nt()),
        ...
        setContent: function setContent(e, t) {
          ...
          if (l) {
            ...
            if (!l.src && l.html && (l.html.tagName ? u.appendChild(l.html) : u.innerHTML = l.html), Zt(l), qt(l, de), !l.src || l.loadError || l.loaded) l.src && !l.loadError && ((n = o.createEl("pswp__img", "img")).style.opacity = 1, n.src = l.src, Ut(l, n), Bt(0, l, u, n));else {
              if (l.loadComplete = function (i) {
                if (s) {
                  if (e && e.index === t) {
                    if (Zt(i, !0)) return i.loadComplete = i.img = null, qt(i, de), ke(i), void (e.index === c && a.updateCurrZoomItem());
                    i.imageAppended ? !_t && i.placeholder && (i.placeholder.style.display = "none", i.placeholder = null) : R.transform && (te || _t) ? Wt.push({
                      item: i,
                      baseDiv: u,
                      img: i.img,
                      index: t,
                ...
                l.msrc && (p.src = l.msrc), Ut(l, p), u.appendChild(p), l.placeholder = p;
              }

              l.loading || Xt(l), a.allowProgressiveImg() && (!Rt && R.transform ? Wt.push({
                item: l,
                baseDiv: u,
                img: l.img,
                index: t,
            ...
            Rt || t !== c ? ke(l) : (ee = u.style, jt(l, n || l.img)), e.el.innerHTML = "", e.el.appendChild(u);
          } else e.el.innerHTML = "";
        },
      ...
      publicMethods: {
        ...
        setupDesktopZoom: function setupDesktopZoom(t) {
          ...
          Ce("bindEvents", function () {
            ...
            Kt && o.unbind(e, i, a.handleMouseWheel);
          }), a.mouseZoomedIn = !1;
        ...
        handleMouseWheel: function handleMouseWheel(e) {
          if (v <= a.currItem.fitRatio) return r.modal && (!r.closeOnScroll || qe || Y ? e.preventDefault() : P && Math.abs(e.deltaY) > 2 && (u = !0, a.close())), !0;
          if (e.stopPropagation(), Kt.x = 0, "deltaX" in e) 1 === e.deltaMode ? (Kt.x = 18 * e.deltaX, Kt.y = 18 * e.deltaY) : (Kt.x = e.deltaX, Kt.y = e.deltaY);else if ("wheelDelta" in e) e.wheelDeltaX && (Kt.x = -.16 * e.wheelDeltaX), e.wheelDeltaY ? Kt.y = -.16 * e.wheelDeltaY : Kt.y = -.16 * e.wheelDelta;else {
    ...
    var ti,
      ...
      return t.pid < 0 && (t.pid = 0), t;
        ...
        gi = function gi() {
      if (ni && clearTimeout(ni), qe || Y) ni = setTimeout(gi, 500);else {
        oi ? clearTimeout(ii) : oi = !0;
        var e = c + 1,
            t = zt(c);
        t.hasOwnProperty("pid") && (e = t.pid);
        var i = si + "&gid=" + r.galleryUID + "&pid=" + e;
        li || -1 === di.hash.indexOf(i) && (ci = !0);
      ...
      publicMethods: {
        initHistory: function initHistory() {
          if (o.extend(r, fi, !0), r.history) {
            di = window.location, ci = !1, ui = !1, li = !1, si = hi(), pi = "pushState" in history, si.indexOf("gid=") > -1 && (si = (si = si.split("&gid=")[0]).split("?gid=")[0]), Ce("afterChange", a.updateURL), Ce("unbindEvents", function () {
              o.unbind(window, "hashchange", a.onHashChange);
            });

            var e = function e() {
              ri = !0, ui || (ci ? history.back() : si ? di.hash = si : pi ? history.pushState("", document.title, di.pathname + di.search) : di.hash = ""), mi();
            };
        ...
        onHashChange: function onHashChange() {
          return hi() === si ? (ui = !0, void a.close()) : void (oi || (ai = !0, a.goTo(vi().pid), ai = !1));
        },
  ...
  "function" == typeof define && define.amd ? define(t) : "object" == (typeof exports === "undefined" ? "undefined" : _typeof2(exports)) ? module.exports = t() : e.PhotoSwipeUI_Default = t();
}(void 0, function () {
  "use strict";
  ...
  return function (e, t) {
    var i,
      ...
      fitControlsWidth: 1200
        ...
        E = function E(e) {
      if (g) return !0;
      e = e || window.event, v.timeToIdle && v.mouseUsed && !c && V();

      for (var i, n, o = (e.target || e.srcElement).getAttribute("class") || "", a = 0; a < z.length; a++) {
        (i = z[a]).onTap && o.indexOf("pswp__" + i.name) > -1 && (i.onTap(), n = !0);
      }
      ...
      return e.shout("shareLinkClick", t, i), !(!i.href || !i.hasAttribute("download") && (window.open(i.href, "pswp_share", "scrollbars=yes,resizable=yes,toolbar=no,location=yes,width=550,height=420,top=100,left=" + (window.screen ? Math.round(screen.width / 2 - 275) : 100)), C || O(), 1));
    },
        M = function M() {
      for (var e, t, i, n, o = "", a = 0; a < v.shareButtons.length; a++) {
        e = v.shareButtons[a], t = v.getImageURLForShare(e), i = v.getPageURLForShare(e), n = v.getTextForShare(e), o += '<a href="' + e.url.replace("{{url}}", encodeURIComponent(i)).replace("{{image_url}}", encodeURIComponent(t)).replace("{{raw_image_url}}", t).replace("{{text}}", encodeURIComponent(n)) + '" target="_blank" class="pswp__share--' + e.id + '"' + (e.download ? "download" : "") + ">" + e.label + "</a>", v.parseShareButtonOut && (o = v.parseShareButtonOut(e, o));
      }
      ...
      for (var i = 0; i < v.closeElClasses.length; i++) {
        ...
        F = 0,
        V = function V() {
      clearTimeout(b), F = 0, c && w.setIdle(!1);
    },
        $ = function $(e) {
    ...
    w.init = function () {
      t.extend(e.options, S, !0), v = e.options, n = t.getChildByClass(e.scrollWrap, "pswp__ui"), d = e.listen, function () {
        var e;
        ...
        t.bind(n, "pswpTap click", E), t.bind(e.scrollWrap, "pswpTap", w.onGlobalTap), e.likelyTouchDevice || t.bind(e.scrollWrap, "mouseover", w.onMouseOver);
      }), d("unbindEvents", function () {
        C || O(), y && clearInterval(y), t.unbind(document, "mouseout", $), t.unbind(document, "mousemove", V), t.unbind(n, "pswpTap click", E), t.unbind(e.scrollWrap, "pswpTap", w.onGlobalTap), t.unbind(e.scrollWrap, "mouseover", w.onMouseOver), i && (t.unbind(document, i.eventK, w.updateFullscreen), i.isFullscreen() && (v.hideAnimationDuration = 0, i.exit()), i = null);
      }), d("destroy", function () {
      ...
      }), d("parseVerticalMargin", _), function () {
        var e,
            i,
            o,
            a = function a(n) {
          if (n) for (var a = n.length, r = 0; a > r; r++) {
            ...
            for (var s = 0; s < z.length; s++) {
              o = z[s], i.indexOf("pswp__" + o.name) > -1 && (v[o.option] ? (t.removeClass(e, "pswp__element--disabled"), o.onInit && o.onInit(e)) : t.addClass(e, "pswp__element--disabled"));
            }
          }
        };
        ...
        r && a(r.children);
      }(), v.shareEl && s && l && (C = !0), P(), v.timeToIdle && d("mouseUsed", function () {
        t.bind(document, "mousemove", V), t.bind(document, "mouseout", $), y = setInterval(function () {
          2 == ++F && w.setIdle(!0);
        }, v.timeToIdle / 2);
      ...
      T && e.currItem ? (w.updateIndexIndicator(), v.captionEl && (v.addCaptionHTMLFn(e.currItem, o), A(o, "caption--empty", !e.currItem.title)), x = !0) : x = !1, C || O(), P();
      ...
      } else if (v.tapToToggleControls && (T ? w.hideControls() : w.showControls()), v.tapToClose && (t.hasClass(n, "pswp__img") || L(n))) return void e.close();
      ...
      T = !0, x || w.update(), t.removeClass(n, "pswp__ui--hidden");
...
var initPhotoSwipeFromDOM = function initPhotoSwipeFromDOM(e) {
  for (var t = function t(e) {
  ...
  }, i = function i(e, t, _i, n) {
    var o,
        a,
        r = document.querySelectorAll(".pswp")[0];
    if (a = function (e) {
      for (var t, i, n, o, a = e.childNodes, r = a.length, s = [], l = 0; l < r; l++) {
        1 === (t = a[l]).nodeType && (n = (i = t.children[0]).getAttribute("data-size").split("x"), o = {
      ...
      getThumbBoundsFn: function getThumbBoundsFn(e) {
    ...
    isNaN(o.index) || (_i && (o.showAnimationDuration = 0), new PhotoSwipe(r, PhotoSwipeUI_Default, a, o).init());
  }, n = document.querySelectorAll(e), o = 0, a = n.length; o < a; o++) {
...
initPhotoSwipeFromDOM(".mdb-lightbox"), function (e) {
  e.fn.sticky = function (t) {
    ...
    return this.each(function () {
      var t = e(this),
          ...
          l = i.zIndex,
          u = t.offset().top - s,
          c = e("<div></div>").width(r).height(a).addClass("sticky-placeholder"),
          d = i.stopper,
          p = e(window);
      ...
      function f() {
        var r = p.scrollTop(),
            f = d,
            h = t.parent().width();
        (c.width(h), o && "string" == typeof d) && (f = e(d).offset().top - a - s);

        if (u < r) {
          if (i.stickyClass && t.addClass(i.stickyClass), t.after(c).css({
            position: "fixed",
            top: s,
            width: h
          }), n && t.css({
      ...
      p.innerHeight() > a && (p.bind("scroll", f), p.bind("load", f), p.bind("resize", f));
    });
  };
}(jQuery), function (e) {
  "use strict";
  ...
  var n,
      ...
      u = /iPad|iPhone|iPod/.test(s) && !e.MSStream,
  ...
  var h = [],
    ...
    return function (t, i) {
      ...
      if (this.$item = t, this.defaults = {
        ...
        onDestroy: null,
        onCoverImage: null
      }, n = JSON.parse(this.$item.getAttribute("data-jarallax") || "{}"), this.options = this.extend({}, this.defaults, n, i), !(!a || l && this.options.noAndroid || u && this.options.noIos)) {
        this.options.speed = Math.min(2, Math.max(-1, parseFloat(this.options.speed)));
        var o = this.options.elementInViewport;
        o && "object" == _typeof2(o) && void 0 !== o.length && (o = o[0]), !o instanceof Element && (o = null), this.options.elementInViewport = o, this.instanceID = e++, this.image = {
  ...
  function g(t) {
    e.requestAnimationFrame(function () {
      ...
      for (var e = 0, i = h.length; e < i; e++) {
        "scroll" !== t.type && (h[e].coverImage(), h[e].clipContainer()), h[e].onScroll();
      }
    });
  }
  ...
  m.prototype.css = function (t, i) {
    ...
    for (var n in i.transform && (r && (i.transform += " translateZ(0)"), i.WebkitTransform = i.MozTransform = i.msTransform = i.OTransform = i.transform), i) {
      t.style[n] = i[n];
    }
    ...
    for (var t = 1; t < arguments.length; t++) {
      if (arguments[t]) for (var i in arguments[t]) {
    ...
    for (var e = 0, t = h.length; e < t; e++) {
      if (h[e].instanceID === this.instanceID) {
        h.splice(e, 1);
        break;
      }
    }
    ...
    for (var n in this.$item.removeAttribute("data-jarallax-original-styles"), "null" === i ? this.$item.removeAttribute("style") : this.$item.setAttribute("style", i), this.$clipStyles && this.$clipStyles.parentNode.removeChild(this.$clipStyles), this.image.$container.parentNode.removeChild(this.image.$container), this.options.onDestroy && this.options.onDestroy.call(this), delete this.$item.jarallax, this) {
      delete this[n];
    }
    ...
    if (this.image.width && this.image.height) {
      var e = this.image.$container.getBoundingClientRect(),
          ...
          p = 0,
          f = 0;
      l && (u = s < 0 ? s * Math.max(i, o) : s * (i + o), s > 1 ? d = Math.abs(u - o) : s < 0 ? d = u / s + Math.abs(u) : d += Math.abs(o - i) * (1 - s), u /= 2), (c = d * a / r) < t && (d = (c = t) * r / a), l ? (p = n + (t - c) / 2, f = (o - d) / 2) : (p = (t - c) / 2, f = (i - d) / 2), "absolute" === this.image.position && (p -= n), this.parallaxScrollDistance = u, this.css(this.image.$item, {
        width: c + "px",
        height: d + "px",
        marginLeft: p + "px",
        marginTop: f + "px"
    ...
    if (this.image.width && this.image.height) {
      ...
      if (this.options.elementInViewport && (s = this.options.elementInViewport.getBoundingClientRect()), this.isElementInViewport = s.bottom >= 0 && s.right >= 0 && s.top <= o && s.left <= n, e || this.isElementInViewport) {
        var l = Math.max(0, i),
            ...
            c = Math.max(0, -i),
            d = Math.max(0, i + a - o),
            p = Math.max(0, a - (i + a - o)),
            f = Math.max(0, -i + o - a),
            h = 1 - 2 * (o - i) / (o + a),
            m = 1;

        if (a < o ? m = 1 - (c || d) / a : u <= o ? m = u / o : p <= o && (m = p / o), "opacity" !== this.options.type && "scale-opacity" !== this.options.type && "scroll-opacity" !== this.options.type || (r.transform = "", r.opacity = m), "scale" === this.options.type || "scale-opacity" === this.options.type) {
          var v = 1;
          this.options.speed < 0 ? v -= this.options.speed * m : v += this.options.speed * (1 - m), r.transform = "scale(" + v + ")";
        }

        if ("scroll" === this.options.type || "scroll-opacity" === this.options.type) {
          var g = this.parallaxScrollDistance * h;
          "absolute" === this.image.position && (g -= i), r.transform = "translateY(" + g + "px)";
        }
  ...
  var y = function y(e) {
    ("object" == (typeof HTMLElement === "undefined" ? "undefined" : _typeof2(HTMLElement)) ? e instanceof HTMLElement : e && "object" == _typeof2(e) && null !== e && 1 === e.nodeType && "string" == typeof e.nodeName) && (e = [e]);

    for (var t, i = arguments[1], n = Array.prototype.slice.call(arguments, 2), o = e.length, a = 0; a < o; a++) {
      if ("object" == _typeof2(i) || void 0 === i ? e[a].jarallax || (e[a].jarallax = new m(e[a], i)) : e[a].jarallax && (t = e[a].jarallax[i].apply(e[a].jarallax, n)), void 0 !== t) return t;
    }
  ...
  if (e.jarallax = y, e.jarallax.noConflict = function () {
    ...
    var w = function w() {
      ...
      var i = y.apply(e, t);
      return "object" != _typeof2(i) ? i : this;
    };
  ...
  n.prototype.parseURL = function (e) {
    var t,
        i = !(!(t = e.match(/.*(?:youtu.be\/|v\/|u\/\w\/|embed\/|watch\?v=)([^#\&\?]*).*/)) || 11 !== t[1].length) && t[1],
        n = function (e) {
    ...
    if (this.userEventsList && this.userEventsList[e]) if (t) for (var i = 0; i < this.userEventsList[e].length; i++) {
      this.userEventsList[e][i] === t && (this.userEventsList[e][i] = !1);
    } else delete this.userEventsList[e];
  }, n.prototype.fire = function (e) {
    var t = [].slice.call(arguments, 1);
    if (this.userEventsList && void 0 !== this.userEventsList[e]) for (var i in this.userEventsList[e]) {
    ...
    n.$iframe ? t(n.$iframe) : n.onAPIready(function () {
      ...
      if (n.$iframe || ((o = document.createElement("div")).style.display = "none"), "youtube" === n.type) {
        ...
        n.playerOptions = {}, n.playerOptions.videoId = n.videoID, n.playerOptions.playerVars = {
          ...
          onStateChange: function onStateChange(e) {
            n.options.loop && e.data === YT.PlayerState.ENDED && n.play(n.options.startTime), c || e.data !== YT.PlayerState.PLAYING || (c = 1, n.fire("started", e)), e.data === YT.PlayerState.PLAYING && n.fire("play", e), e.data === YT.PlayerState.PAUSED && n.fire("pause", e), e.data === YT.PlayerState.ENDED && n.fire("end", e), n.options.endTime && (e.data === YT.PlayerState.PLAYING ? d = setInterval(function () {
      ...
      "vimeo" === n.type && (n.playerOptions = "", n.playerOptions += "player_id=" + n.playerID, n.playerOptions += "&autopause=0", n.options.controls || (n.playerOptions += "&badge=0&byline=0&portrait=0&title=0"), n.playerOptions += "&autoplay=" + (n.options.autoplay ? "1" : "0"), n.playerOptions += "&loop=" + (n.options.loop ? 1 : 0), n.$iframe || (n.$iframe = document.createElement("iframe"), n.$iframe.setAttribute("id", n.playerID), n.$iframe.setAttribute("src", "https://player.vimeo.com/video/" + n.videoID + "?" + n.playerOptions), n.$iframe.setAttribute("frameborder", "0"), o.appendChild(n.$iframe), document.body.appendChild(o)), n.player = n.player || new Vimeo.Player(n.$iframe), n.player.getVideoWidth().then(function (e) {
        ...
        a || n.fire("started", e), a = 1, n.options.endTime && n.options.endTime && e.seconds >= n.options.endTime && (n.options.loop ? n.play(n.options.startTime) : n.pause());
      ...
      if ("local" === n.type) {
        if (!n.$iframe) for (var h in n.$iframe = document.createElement("video"), n.options.mute && (n.$iframe.muted = !0), n.options.loop && (n.$iframe.loop = !0), n.$iframe.setAttribute("id", n.playerID), o.appendChild(n.$iframe), document.body.appendChild(o), n.videoID) {
          r = n.$iframe, s = n.videoID[h], l = "video/" + h, u = void 0, (u = document.createElement("source")).src = s, u.type = l, r.appendChild(u);
        }
        var m;
  ...
  n.prototype.loadAPI = function () {
    if (!o || !a) {
      ...
      if ("youtube" !== this.type || o || (o = 1, t = "//www.youtube.com/iframe_api"), "vimeo" !== this.type || a || (a = 1, t = "//player.vimeo.com/api/player.js"), t) {
  ...
  n.prototype.onAPIready = function (t) {
    if ("youtube" === this.type && ("undefined" != typeof YT && 0 !== YT.loaded || r ? "object" == (typeof YT === "undefined" ? "undefined" : _typeof2(YT)) && 1 === YT.loaded ? t() : l.done(function () {
      t();
    }) : (r = 1, e.onYouTubeIframeAPIReady = function () {
      e.onYouTubeIframeAPIReady = null, l.resolve("done"), t();
    })), "vimeo" === this.type) if ("undefined" != typeof Vimeo || s) "undefined" != typeof Vimeo ? t() : u.done(function () {
      t();
    });else {
      s = 1;
  ...
  return e = $.extend({
    ...
    Object.keys(n).length && (i = $('<ul class="mdb-autocomplete-wrap"></ul>')).insertAfter($(this)), t.on("keyup", function (e) {
      var o = t.val();
      if (i.empty(), o.length) for (var a in n) {
